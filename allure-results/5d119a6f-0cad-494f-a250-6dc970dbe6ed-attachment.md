...
Locator: /html/body/div[1]/div/div/div/div/div[1]/div/div[1]/div/div[2]
Expected: visible
Error: Unexpected token "/" while parsing css selector "/html/body/div[1]/div/div/div/div/div[1]/div/div[1]/div/div[2]". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 30000ms
  - waiting for /html/body/div[1]/div/div/div/div/div[1]/div/div[1]/div/div[2]
      ...
      - generic [ref=f4e39]:
        ...
        - generic [ref=f4e44]:
          - generic [ref=f4e45]:
            - generic [ref=f4e46]:
              ...
              - textbox [disabled] [ref=f4e50]: Sunil S
            - generic [ref=f4e51]:
              - paragraph [ref=f4e52]: Last Name *
              - textbox [disabled] [ref=f4e55]: yadav
          - generic [ref=f4e56]:
            - generic [ref=f4e58]:
              - paragraph [ref=f4e59]: Country *
              - combobox [disabled] [ref=f4e60]:
                - option "Afghanistan"
                - option "Albania"
                - option "Algeria"
            ...
            - generic [ref=f4e62]:
              ...
              - textbox [disabled] [ref=f4e66]: magarpatta
            - generic [ref=f4e68]:
              - paragraph [ref=f4e69]: City *
              - textbox [disabled] [ref=f4e72]: PUNE
            - generic [ref=f4e74]:
              - paragraph [ref=f4e75]: Postal Code *
              - textbox [disabled] [ref=f4e78]: "411027"
            - generic [ref=f4e79]:
              - button "Cancel" [disabled] [ref=f4e80]
              - button "Save" [disabled] [ref=f4e81]
        - separator [ref=f4e82]
        - alert [ref=f4e83]:
          - img "Info:" [ref=f4e85]
        ...
        - generic [ref=f4e89]:
          - generic [ref=f4e93]:
            ...
            - generic [ref=f4e100]:
              - textbox "1 (702) 123-4567" [ref=f4e101]: "+919876543222"
              - 'button "India: + 91" [ref=f4e103]'
          - generic [ref=f4e107]:
            - button "Cancel" [ref=f4e108] [cursor=pointer]
            - button "Save" [active] [ref=f4e109] [cursor=pointer]
...
```ts
  ...
  115 | 
  116 | '/html/body/div[1]/div/div/div/div/div[1]/div/div[1]/div/div[2]'
  117 | 
  118 | );
  119 | 
> 120 | await expect(successPopup).toBeVisible({
      |                            ^ Error: expect(locator).toBeVisible() failed
  121 | 
  122 | timeout: 30000
  123 | 
  ...
  139 |   // await page.locator("//*[@id=':ru:']/button").click();
  140 | 
  141 | 
  142 | 
  143 |   // Step 11: Scroll Up
  144 |   await page.mouse.wheel(0, -1000);
  145 | 
  146 |   // Step 12: Click Change Password
  147 |   await page.getByRole('button', { name: /change password/i }).click();
  148 | 
  149 |   // Step 13: Enter Current Password
  150 |   await page.locator('//*[@id="credentialsForm"]').fill(currentPassword);
  151 | 
  152 |   // Step 14: Enter New Password
  153 |   await page.locator('//*[@id=":rl:"]').fill(newPassword);
  154 | 
  155 |   // Step 15: Enter Confirm Password
  156 |   await page.locator('//*[@id="credentialsForm"]//div[3]//input"]').fill(newPassword);
  157 | 
  158 |   // Step 16: Verify Password Guideline
  159 |   await expect(
  160 |     page.getByText(/password/i)
  161 |   ).toBeVisible();
  162 | 
  163 |   // Step 17: Save Password
  164 |   await page.getByRole('button', { name: /^Save$/ }).click();
  165 | 
  166 |   // Step 18: Verify Password Changed Successfully
  167 |   await expect(
  168 |     page.getByText(/success/i)
  169 |   ).toBeVisible({ timeout: 30000 });
  170 | 
  171 |   // Step 19: Logout
  172 |   await page.getByRole('button', { name: /logout/i }).click();
  173 | 
  174 |   // Step 20: Open URL Again
  175 |   await page.goto(
  176 |     'https://account.deere.com/actmgmt/profile?TARGET=https://map.deere.com/'
  177 |   );
  178 | 
  179 |   // Step 21: Login with New Password
  180 |   await page.locator('#input28').fill(email);
  181 |   await page.locator("//*[@id='form20']/div[2]/input").click();
  182 | 
  ...
  187 | 
  188 |   await expect(
  189 |     page.getByText(/Personal Information/i)
  190 |   ).toBeVisible({ timeout: 60000 });
  191 | 
  192 | });
```