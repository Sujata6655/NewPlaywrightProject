...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    ...
    - waiting for "https://signin.johndeere.com/oauth2/ausabzzga86EIeR4l1t7/v1/authorize?client_id=0oa4tbcmsrJlPC47S5d7&code_challenge=Q-AVGfjCeJhKi7ho3roy5CJ_VO9EhDcgizSSj9f0N-M&code_challenge_method=S256&nonce=Zc36bI…" navigation to finish...
...
> 13 |   await expect(page).toHaveTitle(/Sign In/i);
  ...
  54 |  await expect(
  55 | 
  56 |  page.getByText(/Your personal information is saved/i)
  57 | 
