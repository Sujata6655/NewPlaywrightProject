...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//*[@[@id=":ressDetailsId"]/div[5]/button[2]' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//*[@[@id=":ressDetailsId"]/div[5]/button[2]')
  ...
  - generic [ref=f4e20]:
    ...
    - generic [ref=f4e31]:
      ...
      - generic [ref=f4e36]:
        - generic [ref=f4e37]:
          - generic [ref=f4e38]:
            ...
            - textbox [active] [ref=f4e42]: Sunil S
          - generic [ref=f4e43]:
      ...
      - generic [ref=f4e85]:
        ...
        - generic [ref=f4e92]:
          - textbox "1 (702) 123-4567" [disabled] [ref=f4e93]: "+919976543289"
