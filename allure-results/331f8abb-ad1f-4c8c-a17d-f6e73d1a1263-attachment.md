...
Call log:
  - waiting for locator('#username-input')
    - locator resolved to <input value="" type="text" name="usernameId" id="username-input" aria-invalid="false" class="MuiInputBase-input MuiInput-input MuiInputBase-inputSizeSmall css-1xvtbz5"/>
    - fill("testingprod1001@yopmail.com")
