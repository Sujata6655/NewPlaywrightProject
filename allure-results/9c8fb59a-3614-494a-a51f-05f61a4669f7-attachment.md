...
- Name: test12.spec.ts >> Edit Profile and Change Password
- Location: tests\test12.spec.ts:3:5
...
```ts
  ...
  7   | 
  8   |   const currentPassword = '4e5r6t$E%R^T1';
  9   |   const newPassword = '4e5r6t$E%R^T2';
  10  |    const confirmPassword = '4e5r6t$E%R^T2';
  11  | 
  12  | 
  13  |   // Open URL
  14  |   await page.goto(
