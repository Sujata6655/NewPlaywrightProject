    ...
    - generic [ref=f4e31]:
      ...
      - generic [ref=f4e36]:
        - generic [ref=f4e37]:
          - generic [ref=f4e38]:
            ...
            - textbox [disabled] [ref=f4e42]: Sunil S
          - generic [ref=f4e43]:
            - paragraph [ref=f4e44]: Last Name *
            - textbox [disabled] [ref=f4e47]: yadav
        - generic [ref=f4e48]:
          - generic [ref=f4e50]:
            - paragraph [ref=f4e51]: Country *
            - combobox [disabled] [ref=f4e52]:
              - option "Afghanistan"
              - option "Albania"
              - option "Algeria"
          ...
          - generic [ref=f4e54]:
            ...
            - textbox [disabled] [ref=f4e58]: magarpatta
          - generic [ref=f4e60]:
            - paragraph [ref=f4e61]: City *
            - textbox [disabled] [ref=f4e64]: PUNE
          - generic [ref=f4e66]:
            - paragraph [ref=f4e67]: Postal Code *
            - textbox [disabled] [ref=f4e70]: "411027"
          - generic [ref=f4e71]:
      ...
      - generic [ref=f4e81]:
        - generic [ref=f4e85]:
          ...
          - generic [ref=f4e92]:
            - textbox "1 (702) 123-4567" [active] [ref=f4e93]: "+9198765432"
            - 'button "India: + 91" [ref=f4e95]'
        - generic [ref=f4e99]:
          - button "Cancel" [ref=f4e100] [cursor=pointer]
          - button "Save" [ref=f4e101] [cursor=pointer]
...
> 108 | await page.keyboard.press(digit);
  ...
  193 | 
  194 |   await expect(
  195 |     page.getByText(/Personal Information/i)
  196 |   ).toBeVisible({ timeout: 60000 });
  197 | 
  198 | });
```