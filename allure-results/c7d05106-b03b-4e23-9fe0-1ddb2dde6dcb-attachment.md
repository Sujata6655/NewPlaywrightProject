...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    ...
    - waiting for "https://signin.johndeere.com/oauth2/ausabzzga86EIeR4l1t7/v1/authorize?client_id=0oa4tbcmsrJlPC47S5d7&code_challenge=ikSLlmtu54dZv2GCvXFy-d25ghSPqTipb4r7fZLAzto&code_challenge_method=S256&nonce=RP00Sl…" navigation to finish...
...
> 13 |   await expect(page).toHaveTitle(/Sign In/i);
  ...
  53 |   // Success message
  54 |  
  55 |   const successToast = page.locator('//*[@id="main-content"]/div/div[1]/div');
  56 | 
  57 | await expect(successToast).toBeVisible();
  58 | 
  59 | await expect(successToast).toContainText('Your personal information is saved.');
  60 | 
  61 | 
  62 | 
  63 | });
