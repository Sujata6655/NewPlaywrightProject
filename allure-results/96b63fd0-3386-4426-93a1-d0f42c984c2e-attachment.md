...
Call log:
  ...
  - waiting for getByText('Edit Profile')
    ...
    - navigated to "https://signin.johndeere.com/enduser/callback?code=qH2fJF-l0JsF2zbGkpD2HphbpsWDgueYV4pqZ2X6g_A&state=cERRVZ46INk0qRhY1vxtBNsBDo7xZnyHxgbB4RJdOg09lCynnDFkYF9HzgqV0j8K"
...
```ts
  ...
  25 | const iframeCount = await page.locator('iframe').count();
  26 | 
  27 | console.log('Iframe Count:', iframeCount);
  28 | 
