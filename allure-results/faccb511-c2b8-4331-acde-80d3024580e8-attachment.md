...
- generic [ref=f4e1]:
        ...
        - generic [ref=f4e36]:
          ...
          - generic [ref=f4e48]:
            ...
            - generic [ref=f4e54]:
              ...
              - textbox [ref=f4e58]: 123 Main Street
            - generic [ref=f4e60]:
  ...
  - dialog [ref=f4e138]:
    - heading "Warning!!" [level=2] [ref=f4e139]
    - paragraph [ref=f4e148]: The house number you entered does not match the house number range range in our address directory. Do you still want to continue with the address you entered?
    - generic [ref=f4e149]:
      - button "Cancel" [ref=f4e150] [cursor=pointer]
      - button "Continue" [ref=f4e151] [cursor=pointer]
```
