...
Call log:
  - waiting for locator('#phonenumberForm button[type=\'submit\']')
    - locator resolved to <button tabindex="0" type="submit" class="MuiButtonBase-root MuiButton-root MuiButton-primary MuiButton-primaryOnLight MuiButton-sizeMedium MuiButton-primarySizeMedium MuiButton-colorOnLight MuiButton-fullWidth css-thuy7o">Next</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="myJDLoader_loaderOverlay__soVPx MuiBox-root css-0">…</div> from <div class="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row css-1ks8n1u">…</div> subtree intercepts pointer events
