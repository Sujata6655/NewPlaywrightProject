...
Call log:
  - Expect "toHaveTitle" with timeout 60000ms
    ...
    - waiting for "https://signin.johndeere.com/login/token/redirect?stateToken=02.id.whxbh0GrbqloPHfrL6KtiSeeafg9vGRWYsDSWeiO" navigation to finish...
...
> 26  |   await expect(page).toHaveTitle(/Edit Profile/i, {
  ...
  107 | 
  108 | await page.keyboard.type(digit);
  109 | 
  110 | }
  111 | 
