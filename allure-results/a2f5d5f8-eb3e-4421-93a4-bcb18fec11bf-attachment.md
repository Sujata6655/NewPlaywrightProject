      ...
      - generic [ref=f4e24]:
        - generic [ref=f4e25]:
          ...
          - generic [ref=f4e31]:
            ...
            - textbox [ref=f4e35]: Testing@QAE15
          - generic [ref=f4e40]:
            - paragraph [ref=f4e41]: Confirm New Password *
            - textbox [ref=f4e44]: Testing@QAE15
        - generic [ref=f4e49]:
          - generic [ref=f4e50]:
...
```ts
  ...
  116 | // New Password
  117 | 
  118 | await page.locator(
  119 | 
  120 | 'xpath=//*[@id="credentialsForm"]/div/div[1]/div[2]/div/div/input'
  121 | 
  122 | ).fill(newPassword);
  123 | 
  124 | // Confirm Password
  125 | 
  126 | await page.locator(
  127 | 
  128 | 'xpath=//*[@id="credentialsForm"]/div/div[1]/div[3]/div/div/input'
  129 | 
  130 | ).fill(newPassword);
  131 | 
  132 | 
  133 | 
  134 |   // Save Password
