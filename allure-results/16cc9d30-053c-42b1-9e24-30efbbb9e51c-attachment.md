...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//*[@id[name="firstName="addressDetailsId"2]' is not a valid XPath expression.
...
Call log:
  - waiting for locator('//*[@id[name="firstName="addressDetailsId"2]')
