    ...
    - generic [ref=f4e40]:
      ...
      - generic [ref=f4e51]:
        ...
        - generic [ref=f4e105]:
          ...
          - generic [ref=f4e112]:
            - textbox "1 (702) 123-4567" [disabled] [ref=f4e113]: "+919876543222"
...
```ts
  ...
  33 |     .click();
  34 | 
  35 |   // Open Change Password section
  36 |   const changePasswordButton = page.locator(
  37 |     '//*[@id="sigInInfoId"]/div/button'
  38 |   );
  39 | 
  40 |   await expect(changePasswordButton).toBeVisible({
  41 |     timeout: 30000,
  42 |   });
  43 | 
> 44 |   await changePasswordButton.click();
     |                              ^ Error: locator.click: Test timeout of 30000ms exceeded.
  45 | 
  46 |   // Wait for password fields
  47 |   const passwordFields = page.locator('input[type="password"]');
  48 | 
  49 |   await expect(passwordFields.first()).toBeVisible({
  50 |     timeout: 30000,
  51 |   });
  52 | 
  53 |   // Current Password
  54 |   await passwordFields.nth(0).fill(currentPassword);
  55 | 
  56 |   // New Password
  57 |   await passwordFields.nth(1).fill(newPassword);
  58 | 
  59 |   // Confirm Password
  60 |   await passwordFields.nth(2).fill(newPassword);
  61 | });
```